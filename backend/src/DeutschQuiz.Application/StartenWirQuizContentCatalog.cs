        ...
        params VocabSeed[] vocabulary)
    {
        ...
        var questions = vocabulary
            ...
            [
                ...
                new(QuizCategory.Grammar, $"W-Frage: „Wann ___ er {verb.Infinitive}?“", [verb.Er, verb.Ich, verb.Wir], verb.Er, "در پرسش با کلمهٔ پرسشی، فعل صرف‌شده بلافاصله بعد از کلمهٔ پرسشی قرار می‌گیرد."),
                new(QuizCategory.Grammar, $"Negation: „Wir ___ heute nicht {verb.Infinitive}.“", [verb.Wir, verb.Er, verb.Du], verb.Wir, "در جملهٔ اصلی، فعل صرف‌شده جایگاه دوم می‌آید و «nicht» قبل از بخش پایانی جمله قرار می‌گیرد."),
