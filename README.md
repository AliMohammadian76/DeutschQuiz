...
وب‌اپ آزمون زبان آلمانی برای `Menschen` (A1.1 تا B1.2) و `Starten wir! A1.1`.
...
- آزمون‌های درس‌به‌درس برای `Menschen` در سطوح `A1.1 → A1.2 → A2.1 → A2.2 → B1.1 → B1.2` و `Starten wir! A1.1`
